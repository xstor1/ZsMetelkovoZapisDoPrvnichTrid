...
<body>
<header>
    <nav class="navbar navbar-dark navbar-expand-lg fixed-top" style="background-color:#212529 ">
    ...
    <div class="h2 m-4" style=" padding-top: 60px;">Administrace zápisu</div>
</header>
...
<div class="container-fluid">
    <form class="form-group " method="get">
        <div class="row">
            <h2 class="m-2 ml-4 mr-4 mt-4">Zapsaní žáci</h2>

            <div class="col-xl-3 col-sm-12 col-md-4 col-lg-4 mb-2 mt-4">
                <input class="form-control" type="text" name="rodne"
                       placeholder="Zadejte přijmení které chcete vyhledat...">
            </div>
            <div class="col-xl-2 col-sm-12 col-md-4  col-lg-3 mb-2 mt-4">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <div class="row">
                            <div class="col-6">
                                <form onsubmit="closesmazatall();" class="form-group" action="deleteall.php"
                                      method="post">
        ...
        <div class="container-fluid">
            ...
            <div class="row fixed-bottom">
                <div class="col-sm-12 col-md-12 col-lg-12"
                    ...
                    <div style="color: white; text-align: center">Powered by <a style="color: wheat;" href="https://www.larvasystems.cz/">LarvaSystems</a>
                    </div>
